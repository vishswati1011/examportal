...
public class AddQuestionAnswer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//QuestionAnswer qa=new QuestionAnswer(0,);
		...
		//al.add(t1);
		//int tid=Integer.parseInt(topic);
		if(tid>0) {
			System.out.println("tid========="+tid);
			System.out.println(" inside if statement ");
			SubjectOperation sb1=new SubjectOperation();
			sb1.saveQuestion(0,ques,option1,option2,option3,option4,answer,tid);
